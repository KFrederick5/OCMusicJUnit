...
public class JSONLoaderTest {
    ...
    {
        mConext = InstrumentationRegistry.getTargetContext();
    }
    ...
    {
        try {
            ArrayList<MusicEvent> testList =
                    JSONLoader.loadJSONFromAsset(mConext, "MusicEvents.json");
    ...
    public void testAbnormalLoadJSONFromAsset()
    {
        try {
            ArrayList<MusicEvent> testList =
                    JSONLoader.loadJSONFromAsset(mConext, "DoesNotExist.json");
